...
# TODO: Load a pre-trained network
...
model_from_file = load_checkpoint('checkpoint.pth')
...
def convertCategoryToName(categories):
...
def display_preds(image_path, model, topk=5, flower_names=None):
...
image_path = 'flowers/test/10/image_07090.jpg'
display_preds(image_path, model_from_file, flower_names=cat_to_name)
